...
pub const APP_NAME: &str = "youtube-music-player";
...
pub const MAX_TRACK_DURATION_SECS: u64 = 420;
...
pub const MAX_PLAYLIST_URL_LEN: usize = 2048;
...
pub const TEMP_FILE_MAX_AGE_SECS: u64 = 3600;

/// Number of tracks to pre-download ahead of the current position.
pub const LOOKAHEAD_DOWNLOAD_COUNT: usize = 10;

/// Number of tracks to pre-download on startup/queue restore.
pub const STARTUP_DOWNLOAD_COUNT: usize = 5;
...
pub const FEED_CACHE_TTL_SECS: u64 = 30 * 60; // 30 minutes
